...
> **Key packages detected in this repo:** `streamlit` · `pandas` · `numpy` · `scikit-learn` · `joblib` · `matplotlib` · `google-genai` · `pillow` · `seaborn` · `xgboost`
...
```bash
git clone https://github.com/Devanik21/Chatgpt-4-bot.git
cd Chatgpt-4-bot
